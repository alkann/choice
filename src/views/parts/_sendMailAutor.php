...
$template = $twig->loadTemplate('email_to_author.html.twig');
$message = $template->render(
    array('user'=>$user_total_array)
);
$subject = 'Zamówienie'.$urs_inf['user_name'].' '.$urs_inf['surname'];
...
// Additional headers
$headers .= 'To: Choice <kontakt@choiceunderwear.pl>' . "\r\n";
$headers .= 'From: Choice <kontakt@choiceunderwear.pl>' . "\r\n";

mail('kontakt@choiceunderwear.pl', $subject, $message, $headers);
?>